...
class TestAlert(unittest.TestCase):
    ...
    def test1(self):
        """test alert up"""
        site = websitemonitor.Sitereport('https://google.com', 5)
        site.add_stats()  # add the first stats
        site.availability = [0]
        site.alert(False)  # create a first alert
    ...
    def test3(self):
        ...
        site.alert(False)  # create a first alert without printing option
        site.add_stats()
        site.availability = [0.7, 1]  # make sure that average avail>0.8
        site.alert(False)  # the second alert should shut the first alert down turning it to none
    ...
    def test4(self):
        ...
        site.alert(False)  # the third alert should create a new alert down turning it to none
